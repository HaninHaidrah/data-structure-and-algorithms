...
const sortStarWarsCharacters = (starWarsArr) => {
  // Solution code here...
  let fillteredArr = starWarsArr.filter((el) => {
    return el.height;
  });
  let sortedArray = fillteredArr.sort((a, b) => {
