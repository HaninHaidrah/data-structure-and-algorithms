...
const addOne = (arr) => {
  // Solution code here...
    ...
    let newArr = [];
    array.forEach((value) => {
      let increamet = value + 1;
  
      newArr.push(increamet);
    });
...
const addExclamation = (arr) => {
  // Solution code here...
    ...
    let newArr = [];
    array.forEach((value) => {
      let exclamination = value + "!";
  
      newArr.push(exclamination);
    });
...
const speaker = (words, callback) => {
  ...
  let newArry = [];
  array.forEach((value) => {
    let newWords = callBackFunction(value);
    newArry.push(newWords);
  });
  return newArry;
};;
...
const addNumbers = (num, arr, times, callback) => {
  // Solution code here...
  let array = arr;
  let numberToBeAdded = num;
  let numberOfTimes = times;
  let callBackFunction = callback;
  let newArr = [];
  let i = 0;
  while (i < numberOfTimes) {
    callBackFunction(array, numberToBeAdded);
    i++;
  }
